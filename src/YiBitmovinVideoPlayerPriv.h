#ifndef _YI_BITMOVIN_VIDEO_PLAYER_PRIV_H_
#define _YI_BITMOVIN_VIDEO_PLAYER_PRIV_H_
...
class CYIBitmovinVideoPlayerPriv : public CYISignalHandler,
                                  public CYIAbstractVideoPlayer::TimedMetadataInterface
{
public:
    CYIBitmovinVideoPlayerPriv(CYIBitmovinVideoPlayer *pPub);
    CYIBitmovinVideoPlayerPriv(CYIBitmovinVideoPlayer *pPub, yi::rapidjson::Document &&playerConfiguration);
    virtual ~CYIBitmovinVideoPlayerPriv();
...
private:
    ...
    CYIBitmovinVideoPlayer *m_pPub;
};

#endif // _YI_BITMOVIN_VIDEO_PLAYER_PRIV_H_
