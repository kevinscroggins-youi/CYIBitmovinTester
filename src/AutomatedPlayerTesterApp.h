...
static const uint16_t ACTION_GET_SEEKABLERANGES = 20;
static const uint16_t ACTION_SEEK_TO_LOWEST_SEEKABLE_STARTTIME = 21;
static const uint16_t ACTION_SEEK_TO_HIGHEST_SEEKABLE_ENDTIME = 22;
static const uint16_t ACTION_SEEK_BELOW_LOWEST_SEEKABLE_STARTTIME = 23;
static const uint16_t ACTION_SEEK_ABOVE_HIGHEST_SEEKABLE_ENDTIME = 24;
...
static const uint16_t EVALUATOR_SEEKABLERANGES_NOT_EMPTY = 7;
static const uint16_t EVALUATOR_PLAYBACK_COMPLETED = 8;
...
public:
    ...
    public:
        ...
        CYIAbstractVideoPlayer::SeekableRange GetSeekableRangeLimit();
    };
...
private:
    ...
    YI_TYPE_BASES(AutomatedPlayerTesterApp, TestApp)
};
